...
public class FirebaseManager : MonoBehaviour
{
    ...
    //Celear login field and registerfield
    ...
    private IEnumerator Login(string _email, string _password)
    {
        ...
        else
        {
            ...
            PlayerPrefs.SetString("namalengkap", User.DisplayName);
    ...
    public void MonstersKomponen()
    {
        StartCoroutine(Monsters("api", 1));
    }

    void LoadMonsterID()
    {
        StartCoroutine(LoadMyMonsterID());
    }

    private IEnumerator LoadMyMonsterID()
    {
        ...
        else
        {
            //Data has been retrieved
            DataSnapshot snapshot = DBTask.Result;
            Debug.Log(snapshot.Child("urutanmonster").Value.ToString());
